...
const DEFAULT_EMBED_SETTINGS: AppSettings = {
  ...
  pinnedSpellPaletteOpen: false,
  pinnedSpellPaletteIconSize: 32,
  pinnedSpellPaletteRows: 4,
  pinnedSpellPaletteWrapLimit: 24,
  ...
  pinnedSpellPaletteShowOnEveryWand: false,
  themeColors: [],
  wrapLimit: 21,
  hideLabels: false,
  ...
  mobileEditToolbarEnabled: false,
